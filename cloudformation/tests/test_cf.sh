...
PUBLIC_SUBNET=$(aws ec2 describe-subnets \
  --filters "Name=vpc-id,Values=$VPC_ID" "Name=tag:Name,Values=PublicSubnet" \
...
PUBLIC_RT_ID=$(aws ec2 describe-route-tables \
  --filters "Name=vpc-id,Values=$VPC_ID" "Name=tag:Name,Values=PublicRouteTable" \
  --query "RouteTables[0].RouteTableId" --output text)

PRIVATE_RT_ID=$(aws ec2 describe-route-tables \
  --filters "Name=vpc-id,Values=$VPC_ID" "Name=tag:Name,Values=PrivateRouteTable" \
  --query "RouteTables[0].RouteTableId" --output text)
...
PUBLIC_EC2=$(aws ec2 describe-instances \
  --filters "Name=vpc-id,Values=$VPC_ID" "Name=tag:Name,Values=PublicInstance*" \
  --query "Reservations[].Instances[].InstanceId" --output text)

PRIVATE_EC2=$(aws ec2 describe-instances \
  --filters "Name=vpc-id,Values=$VPC_ID" "Name=tag:Name,Values=PrivateInstance" \
  --query "Reservations[].Instances[].InstanceId" --output text)
...
PUB_SG=$(aws ec2 describe-security-groups \
  --filters "Name=vpc-id,Values=$VPC_ID" "Name=tag:Name,Values=PublicEC2SG" \
  --query "SecurityGroups[0].GroupId" --output text)

PRIV_SG=$(aws ec2 describe-security-groups \
  --filters "Name=vpc-id,Values=$VPC_ID" "Name=tag:Name,Values=PrivateEC2SG" \
  --query "SecurityGroups[0].GroupId" --output text)
